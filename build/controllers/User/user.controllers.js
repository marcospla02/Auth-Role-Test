        ...
        function _callee$(_context) {
          while (1)
            switch ((_context.prev = _context.next)) {
              case 0:
                _context.prev = 0;
                (User = _db.models.User), (Permission = _db.models.Permission);
                _context.next = 4;
                return User.findAll({
                  attributes: [
                    "id",
              ...
              case 4:
                ...
                allUser = allUser.map(function (user) {
                  return _objectSpread(
                    _objectSpread({}, user.dataValues),
                    {},
                    {
                      Permissions: user.Permissions.map(function (per) {
                        return per.name;
                      }),
                    }
                  );
            ...
            switch ((_context2.prev = _context2.next)) {
              case 0:
                ...
                (_req$body = req.body),
                  ...
                  (permission = _req$body.permission);
              ...
              case 5:
                ...
                _context2.t3 = email;
                _context2.next = 11;
                return _User.UserModel.prototype.encryptPassword(password);
              case 11:
              ...
              case 19:
                permissionsFound = _context2.sent;
